...
(function (a, b) {
  ...
  return function (d) {
    (this.options = Object.assign({}, b)),
      ...
      (this.valid = !0),
      '' == this.options.username && '' == this.options.tag
        ? (console.error('InstagramFeed: Error, no username or tag defined.'),
          (this.valid = !1))
        : this.options.get_data || '' != this.options.container
          ...
          if (4 === c.readyState)
            if (200 === c.status) {
              var e = c.responseText
                ...
                .split('</script>')[0];
              (e = JSON.parse(e.substr(0, e.length - 1))),
                (e = e.entry_data.ProfilePage || e.entry_data.TagPage || null),
                null === e
                  ? (console.log(b),
                    console.error(
                  ...
                  : ((e = e[0].graphql.user || e[0].graphql.hashtag), a(e, d));
            } else
              console.error(
                'InstagramFeed: Request error. Response: ' + c.statusText,
              );
        }),
          c.open('GET', b, !0),
          c.send();
      ...
      (this.parse_caption = function (a, b) {
        return 'undefined' != typeof a.node.edge_media_to_caption.edges[0] &&
          0 != a.node.edge_media_to_caption.edges[0].node.text.length
          ? a.node.edge_media_to_caption.edges[0].node.text
          : 'undefined' != typeof a.node.title_ && 0 != a.node.title_.length
          ? a.node.title_
